...
parseComplete :: String -> ([Dir], [Dir], [Dir], [Dir])
parseComplete x = (parseIns (moo !! 0), parseIns (moo !! 1), parseIns (moo !! 2), parseIns (moo !! 3))
  where moo = words x
...
answer :: Int -> ([Dir], [Dir], [Dir], [Dir]) -> (Int, Int, Int, Int)
answer x (q, w, e, r) = (dO, dT, dH, dF)
...
--Not 9728, 9728 is too high. Actual answer is lower
--Not 9728, 9728 is too high. Actual answer is lower
