...
function evaluate(input, args) // Executes different code depending on input and arguments 
{
	...
	else if (input == "site" || input == "facebook" || input == "wikipedia" || input == "discord" || input == "trello" || input == "reddit" || input == "drive" || input == "4chan" || input == "github") // This just redirects either to a site shorthand such as facebook
	{
		redir(input, args);
	}
